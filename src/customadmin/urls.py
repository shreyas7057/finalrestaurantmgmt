...
from .views import admin_index,all_customers,all_customers_export_as_csv,all_customers_export_as_pdf,customers_area_graph,FoodCreateView,all_menu_display_admin,single_menu_admin,edit_single_menu_admin,logout_admin
...
urlpatterns = [
    ...
    path('single_food_admin/<int:id>',single_menu_admin,name='single_food_admin'),
